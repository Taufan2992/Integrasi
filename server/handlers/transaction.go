...
import (
	...
	transactiondto "golang/dto/transaction"
	"golang/models"
	"golang/repositories"
	"log"
	"net/http"
...
func (h *handlerTransaction) UpdateTransaction(w http.ResponseWriter, r *http.Request) {
	...
	var s = snap.Client{}
	s.New("SB-Mid-server-GNMPJ-_hltoOSr0pNNNgBHgU", midtrans.Sandbox)
...
func SendMail(status string, transaction models.TransactionMail) {

	if status != transaction.Status && (status == "success") {
		var CONFIG_SMTP_HOST = "smtp.gmail.com"
		var CONFIG_SMTP_PORT = 587
		var CONFIG_SENDER_NAME = "Undefined <azkiawardani7@gmail.com>"
		var CONFIG_AUTH_EMAIL = os.Getenv("EMAIL_SYSTEM")
		var CONFIG_AUTH_PASSWORD = os.Getenv("PASSWORD_SYSTEM")

		var productName = transaction.Product.Title
